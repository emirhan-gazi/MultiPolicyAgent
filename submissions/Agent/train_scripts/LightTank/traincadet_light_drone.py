...
def main():
    ...
    register_env("ray", lambda config: LightTank(args, agents))
    ...
    run_experiments({
        "risky_ppo_recruit": {
            ...
            "env": "ray",
            "stop": {
                "training_iteration": 1e6,
            },
            "config": config,
            "checkpoint_freq": 50,
            #"restore": "/home/emirhan/Desktop/DRL-Competition-main/models/attack/checkpoint_000400/checkpoint-400"
        },
     })
