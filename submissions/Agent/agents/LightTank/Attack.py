...
class Attack(BaseLearningAgentGym):
        ...
        for i in range(y_max):
            for j in range(x_max):
                if units[team][i][j]<6 and units[team][i][j] != 0:
                    ...
                    {   
                        'unit': units[team][i][j],
                        'tag': Attack.tagToString[units[team][i][j]],
                        'hp': hps[team][i][j],
                        'location': (i,j),
                        'load': load[team][i][j]
                    }
                ...
                if units[enemy_team][i][j]<6 and units[enemy_team][i][j] != 0:
                    ...
                    {   
                        ...
                        'tag': Attack.tagToString[units[enemy_team][i][j]],
    ...
    def just_decode_state(obs, team, enemy_team):
        state, _ = Attack._decode_state(obs, team, enemy_team)
        return state
